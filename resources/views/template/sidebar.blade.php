                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                              ...
                              <li>
                                <a href="{{URL('/Visa')}}" class="waves-effect">
                            ...
                            <li>
                                <a href="{{URL('/Parties')}}" class="waves-effect">
                                    ...
                                    <span key="t-calendar">Customers / Supplier</span>
                                </a>
                            </li> 
     ...
     <li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    ...
                                    <span key="t-ecommerce">Inventory Reports</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
               ...
               <li> <a  href="{{URL('/SalemanReport')}}" key="t-products" >Salesman Report</a></li>
