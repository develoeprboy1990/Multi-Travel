...
?>
 ...
 <table width="800" border="0" cellspacing="0" cellpadding="0">
      ...
      <td width="50%" rowspan="4" valign="top"><img src="{{asset('uploads/'.$branch_det->BranchLogo)}}" width="30%;" ></td>
    </tr>
      <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" border="1">
  <tr>
    <td width="50"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999" style="border-collapse:collapse;">
      <tr bgcolor="#CCCCCC">
        <td width="5%" height="15"><div align="center"><strong>S/NO</strong></div></td>
        ...
        <td width="10%" height="15" ><div align="center"><strong>FARE</strong></div></td>
        <td width="10%" height="15" ><div align="center"><strong>O/P VAT </strong></div></td>
        <td width="10%" height="15" ><div align="center"><strong>TOTAL</strong></div></td>
      </tr>
   
      <tr >
        <td height="400" valign="top" style="padding: 5px;"> @foreach($invoice_det as $key => $value) 
          <div style="padding: 1px;">{{$key+1}}</div>  <BR> @endforeach</td>
        <td height="400" valign="top" style="padding: 5px;"> @foreach($invoice_det as $key => $value) 
          <div style="padding: 1px;">{{$value->ItemName}}  </div><BR> @endforeach</td>
        <td height="400" valign="top" style="padding: 5px;"> @foreach($invoice_det as $key => $value) 
 ...
 <tr>
        ...
        <td width="10%" height="15" bgcolor="#CCCCCC" ><div align="right"><strong>{{number_format($invoice_mst->Total,2)}}</strong></div></td>
      </tr>
 <tr>
   <td height="15"  colspan="7" style="padding-left: 10px;" ><strong>PREVIOUS BALANCE </strong></td>
   <td height="15" ><div align="right"><strong>{{number_format($invoice_mst->Paid,2)}}</strong></div></td>
 </tr>
 <tr>
   <td height="15"  colspan="7" style="padding-left: 10px;" ><strong>NET PAYABLE AED </strong>{{ucwords(convert_number_to_words($invoice_mst->Paid))}} Only/-</td>
   <td height="15" ><div align="right"><strong>{{number_format($invoice_mst->Balance,2)}}</strong></div></td>
 </tr>
