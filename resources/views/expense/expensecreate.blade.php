                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div id="invoict_type"> <input type="text" name="ExpenseNo" autocomplete="off" class="form-control" value="EXP-{{$vhno[0]->VHNO}}"></div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr class="p-3">
                                            ...
                                            <td class="d-none">
                                                <input type="number" name="Price[]" id="Price_1" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="1">
                                            </td>

                                            <td>
                                                <select name="Tax[]" id="TaxID_1" class="form-select changesNo tax exclusive_cal" required="">
                                                    <?php foreach ($tax as $key => $valueX1) : ?>
                                                        <option value="{{$valueX1->TaxPer}}">{{$valueX1->Description}}</option>
                                                    <?php endforeach ?>
                                                </select>
                                            ...
                                            <td>
                                                <input type="number" name="TaxVal[]" id="TaxVal_1" class=" form-control totalLinePrice2 tax" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01">
                                            </td>
  ...
  calculateTotal();
    ...
    function calculateTotal() {
        ...
        grand_tax = $('#taxpercentage').val();
         console.log('grand_tax: '+grand_tax);
        ...
        shipping_grand = shipping + total2 + grandtotaltax;
        console.log('shipping_grand: '+shipping_grand);
