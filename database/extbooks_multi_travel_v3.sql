...
(1, 1, 7, 2, '54322', 'Ahsan Elahi', '423', 'Busniess', 42.00, '442', 7.90, 150.10, 43.00, 32.00, 2.00, 200.00);
...
(1, 1, '2023-07-26', '2023-07-26', 1, 1, 1, '110101', NULL, 200, 0, 200);
...
(1, 'PC23070001', 'PC', 110100, NULL, NULL, NULL, NULL, 1, NULL, 'Narration sub 1 (BANK DEPOSITS) ', NULL, NULL, 23.00, 0),
(2, 'PC23070001', 'PC', 110200, NULL, NULL, NULL, NULL, 1, NULL, 'Narration sub 1', NULL, 23.00, NULL, 0),
(3, 'PC23070001', 'PC', 110100, NULL, NULL, NULL, NULL, 1, NULL, 'Narration sub 2 (CASH IN HAND) ', NULL, NULL, 55.00, 0),
(4, 'PC23070001', 'PC', 110101, NULL, NULL, NULL, NULL, 1, NULL, 'Narration sub 2', NULL, 55.00, NULL, 0),
(5, 'PC23070001', 'PC', 110100, NULL, NULL, NULL, NULL, 1, NULL, 'Narration sub (CASH Account) ', NULL, NULL, 100.00, 0),
(6, 'PC23070001', 'PC', 110100, NULL, NULL, NULL, NULL, 1, NULL, 'Narration sub', NULL, 100.00, NULL, 0),
(7, 'PC23070001', 'PC', 110100, NULL, NULL, NULL, NULL, 1, NULL, 'Narration sub 2 (CASH IN HAND) ', NULL, NULL, 200.00, 0),
(8, 'PC23070001', 'PC', 110101, NULL, NULL, NULL, NULL, 1, NULL, 'Narration sub 2', NULL, 200.00, NULL, 0),
(9, 'JV23070001', 'JV', 510104, NULL, 1, NULL, 1, NULL, NULL, 'Discount allowed', '2023-07-26', 25000.00, NULL, 0),
(10, 'JV23070001', 'JV', 110400, NULL, 1, NULL, 1, NULL, NULL, 'Discount allowed', '2023-07-26', NULL, 25000.00, 0),
(24, 'SI1', 'SI', 110400, 1, 1, NULL, NULL, NULL, 1, NULL, '2023-07-26', 200.00, NULL, 105),
(25, 'SI1', 'SI', 510103, 1, 2, NULL, NULL, NULL, 1, NULL, '2023-07-26', NULL, 42.00, 106),
(26, 'SI1', 'SI', 410101, 1, 2, NULL, NULL, NULL, 1, NULL, '2023-07-26', NULL, 150.10, 107),
(27, 'SI1', 'SI', 510103, 1, 2, NULL, NULL, NULL, 1, NULL, '2023-07-26', 42.00, NULL, 109),
(28, 'SI1', 'SI', 210100, 1, 2, NULL, NULL, NULL, 1, NULL, '2023-07-26', NULL, 42.00, 110),
(29, 'SI1', 'SI', 210300, 1, 1, NULL, NULL, NULL, 1, NULL, '2023-07-26', NULL, 7.90, 111),
(30, 'SI1', 'SI', 410155, 1, 1, NULL, NULL, NULL, 1, NULL, '2023-07-26', 2.00, NULL, 203);
...
(1, 1, 1, 'Test Customer', 'Address Line 1', '+923339322880', 'mr.elahi.ehsan@gmail.com', 'Yes', 30, '2023-07-26 06:05:34'),
(2, 6, 1, 'Test Supplier', 'Address Line 1', '+923339322880', 'mr.elahi.ehsan@gmail.com', 'Yes', 30, '2023-07-26 06:05:46');
...
(1, 1, 'PC23070001', NULL, NULL, 110100, 'Narration sub', '1111', '2222', 100.00, 110100),
(2, 1, 'PC23070001', NULL, NULL, 110101, 'Narration sub 2', '3333', '4444', 200.00, 110100);
...
INSERT INTO `pettycash_master` (`PettyMstID`, `UserID`, `PettyVoucher`, `ChOfAcc`, `Date`, `Narration`, `Credit`) VALUES
(1, 1, 'PC23070001', 110100, NULL, 'Main Narration', 300.00);
...
(5, 1, 1, 'Invoice', 'List', 'Y'),
(6, 1, 1, 'Invoice', 'Create', 'Y'),
(7, 1, 1, 'Invoice', 'Update', 'Y'),
(8, 1, 1, 'Invoice', 'Delete', 'Y'),
(9, 1, 1, 'Invoice', 'View', 'Y'),
(10, 1, 1, 'Invoice', 'PDF', 'Y'),
(11, 1, 1, 'Voucher', 'List', 'Y'),
(12, 1, 1, 'Voucher', 'Create', 'Y'),
(13, 1, 1, 'Voucher', 'Update', 'Y'),
(14, 1, 1, 'Voucher', 'Delete', 'Y'),
(15, 1, 1, 'Voucher', 'View', 'Y'),
(16, 1, 1, 'Petty Cash', 'List', 'Y'),
(17, 1, 1, 'Petty Cash', 'Create', 'Y'),
(18, 1, 1, 'Petty Cash', 'Update', 'Y'),
(19, 1, 1, 'Petty Cash', 'Delete', 'Y'),
(20, 1, 1, 'Petty Cash', 'View', 'Y'),
(21, 1, 1, 'Adjustment Balance', 'Create', 'Y'),
(22, 1, 1, 'Chart of Account', 'List / Create', 'Y'),
(23, 1, 1, 'Chart of Account', 'Update', 'Y'),
(24, 1, 1, 'Chart of Account', 'Delete', 'Y'),
(25, 1, 1, 'Item/Inventory', 'List / Create', 'Y'),
(26, 1, 1, 'Item/Inventory', 'Update', 'Y'),
(27, 1, 1, 'Item/Inventory', 'Delete', 'Y'),
(28, 1, 1, 'Party / Customers', 'List / Create', 'Y'),
(29, 1, 1, 'Party / Customers', 'Update', 'Y'),
(30, 1, 1, 'Party / Customers', 'Delete', 'Y'),
(31, 1, 1, 'Supplier', 'List / Create', 'Y'),
(32, 1, 1, 'Supplier', 'Update', 'Y'),
(33, 1, 1, 'Supplier', 'Delete', 'Y'),
(34, 1, 1, 'User', 'List / Create', 'Y'),
(35, 1, 1, 'User', 'Update', 'Y'),
(36, 1, 1, 'User', 'Delete', 'Y'),
(37, 1, 1, 'User Rights', 'Assign', 'Y'),
(38, 1, 1, 'Party Ledger', 'View', 'Y'),
(39, 1, 1, 'Party Ledger', 'PDF', 'Y'),
(40, 1, 1, 'Party Balance', 'View', 'Y'),
(41, 1, 1, 'Party Balance', 'PDF', 'Y'),
(42, 1, 1, 'Yearly Report', 'View', 'Y'),
(43, 1, 1, 'Yearly Report', 'PDF', 'Y'),
(44, 1, 1, 'Ageing Report', 'View', 'Y'),
(45, 1, 1, 'Ageing Report', 'PDF', 'Y'),
(46, 1, 1, 'Party Analysis', 'View', 'Y'),
(47, 1, 1, 'Party Analysis', 'PDF', 'Y'),
(48, 1, 1, 'Party List', 'View', 'Y'),
(49, 1, 1, 'Party List', 'PDF', 'Y'),
(50, 1, 1, 'Outstanding Invoices', 'View', 'Y'),
(51, 1, 1, 'Outstanding Invoices', 'PDF', 'Y'),
(52, 1, 1, 'Supplier Ledger', 'View', 'Y'),
(53, 1, 1, 'Supplier Ledger', 'PDF', 'Y'),
(54, 1, 1, 'Supplier Balance', 'View', 'Y'),
(55, 1, 1, 'Supplier Balance', 'PDF', 'Y'),
(56, 1, 1, 'Sale Invoice', 'View', 'Y'),
(57, 1, 1, 'Sale Invoice', 'PDF', 'Y'),
(58, 1, 1, 'Ticket Register', 'View', 'Y'),
(59, 1, 1, 'Ticket Register', 'PDF', 'Y'),
(60, 1, 1, 'Airline Summary', 'View', 'Y'),
(61, 1, 1, 'Airline Summary', 'PDF', 'Y'),
(62, 1, 1, 'Sale Man Report', 'View', 'Y'),
(63, 1, 1, 'Sale Man Report', 'PDF', 'Y'),
(64, 1, 1, 'Tax Report', 'View', 'Y'),
(65, 1, 1, 'Tax Report', 'PDF', 'Y'),
(66, 1, 1, 'Sales Report', 'View', 'Y'),
(67, 1, 1, 'Sales Report', 'PDF', 'Y'),
(68, 1, 1, 'Voucher Report', 'View', 'Y'),
(69, 1, 1, 'Voucher Report', 'PDF', 'Y'),
(70, 1, 1, 'Cash Book', 'View', 'Y'),
(71, 1, 1, 'Cash Book', 'PDF', 'Y'),
(72, 1, 1, 'Day Book', 'View', 'Y'),
(73, 1, 1, 'Day Book', 'PDF', 'Y'),
(74, 1, 1, 'General Ledger', 'View', 'Y'),
(75, 1, 1, 'General Ledger', 'PDF', 'Y'),
(76, 1, 1, 'Trial Balance', 'View', 'Y'),
(77, 1, 1, 'Trial Balance', 'PDF', 'Y'),
(78, 1, 1, 'Trial with Activity', 'View', 'Y'),
(79, 1, 1, 'Trial with Activity', 'PDF', 'Y'),
(80, 1, 1, 'Yearly Summary', 'View', 'Y'),
(81, 1, 1, 'Yearly Summary', 'PDF', 'Y'),
(82, 1, 1, 'Profit & Loss', 'View', 'Y'),
(83, 1, 1, 'Profit & Loss', 'PDF', 'Y'),
(84, 1, 1, 'Balance Sheet', 'View', 'Y'),
(85, 1, 1, 'Balance Sheet', 'PDF', 'Y'),
(86, 1, 1, 'Invoice Summary', 'View', 'Y'),
(87, 1, 1, 'Invoice Summary', 'PDF', 'Y'),
(88, 1, 1, 'Party Wise Sale', 'View', 'Y'),
(89, 1, 1, 'Party Wise Sale', 'PDF', 'Y'),
(90, 1, 1, 'Branch', 'Create/List', 'Y'),
(91, 1, 1, 'Branch', 'Update', 'Y'),
(92, 1, 1, 'Branch', 'Delete', 'Y'),
(93, 2, 2, 'Invoice', 'List', 'Y'),
(94, 2, 2, 'Invoice', 'Create', 'Y'),
(95, 2, 2, 'Invoice', 'Update', 'Y'),
(96, 2, 2, 'Invoice', 'Delete', 'Y'),
(97, 2, 2, 'Invoice', 'View', 'Y'),
(98, 2, 2, 'Invoice', 'PDF', 'Y'),
(99, 2, 2, 'Voucher', 'List', 'Y'),
(100, 2, 2, 'Voucher', 'Create', 'Y'),
(101, 2, 2, 'Voucher', 'Update', 'Y'),
(102, 2, 2, 'Voucher', 'Delete', 'Y'),
(103, 2, 2, 'Voucher', 'View', 'Y'),
(104, 2, 2, 'Petty Cash', 'List', 'Y'),
(105, 2, 2, 'Petty Cash', 'Create', 'Y'),
(106, 2, 2, 'Petty Cash', 'Update', 'Y'),
(107, 2, 2, 'Petty Cash', 'Delete', 'Y'),
(108, 2, 2, 'Petty Cash', 'View', 'Y'),
(109, 2, 2, 'Adjustment Balance', 'Create', 'Y'),
(110, 2, 2, 'Chart of Account', 'List / Create', 'Y'),
(111, 2, 2, 'Chart of Account', 'Update', 'Y'),
(112, 2, 2, 'Chart of Account', 'Delete', 'Y'),
(113, 2, 2, 'Item/Inventory', 'List / Create', 'Y'),
(114, 2, 2, 'Item/Inventory', 'Update', 'Y'),
(115, 2, 2, 'Item/Inventory', 'Delete', 'Y'),
(116, 2, 2, 'Party / Customers', 'List / Create', 'Y'),
(117, 2, 2, 'Party / Customers', 'Update', 'Y'),
(118, 2, 2, 'Party / Customers', 'Delete', 'Y'),
(119, 2, 2, 'Supplier', 'List / Create', 'Y'),
(120, 2, 2, 'Supplier', 'Update', 'Y'),
(121, 2, 2, 'Supplier', 'Delete', 'Y'),
(122, 2, 2, 'User', 'List / Create', 'Y'),
(123, 2, 2, 'User', 'Update', 'Y'),
(124, 2, 2, 'User', 'Delete', 'Y'),
(125, 2, 2, 'User Rights', 'Assign', 'Y'),
(126, 2, 2, 'Party Ledger', 'View', 'Y'),
(127, 2, 2, 'Party Ledger', 'PDF', 'Y'),
(128, 2, 2, 'Party Balance', 'View', 'Y'),
(129, 2, 2, 'Party Balance', 'PDF', 'Y'),
(130, 2, 2, 'Yearly Report', 'View', 'Y'),
(131, 2, 2, 'Yearly Report', 'PDF', 'Y'),
(132, 2, 2, 'Ageing Report', 'View', 'Y'),
(133, 2, 2, 'Ageing Report', 'PDF', 'Y'),
(134, 2, 2, 'Party Analysis', 'View', 'Y'),
(135, 2, 2, 'Party Analysis', 'PDF', 'Y'),
(136, 2, 2, 'Party List', 'View', 'Y'),
(137, 2, 2, 'Party List', 'PDF', 'Y'),
(138, 2, 2, 'Outstanding Invoices', 'View', 'Y'),
(139, 2, 2, 'Outstanding Invoices', 'PDF', 'Y'),
(140, 2, 2, 'Supplier Ledger', 'View', 'Y'),
(141, 2, 2, 'Supplier Ledger', 'PDF', 'Y'),
(142, 2, 2, 'Supplier Balance', 'View', 'Y'),
(143, 2, 2, 'Supplier Balance', 'PDF', 'Y'),
(144, 2, 2, 'Sale Invoice', 'View', 'Y'),
(145, 2, 2, 'Sale Invoice', 'PDF', 'Y'),
(146, 2, 2, 'Ticket Register', 'View', 'Y'),
(147, 2, 2, 'Ticket Register', 'PDF', 'Y'),
(148, 2, 2, 'Airline Summary', 'View', 'Y'),
(149, 2, 2, 'Airline Summary', 'PDF', 'Y'),
(150, 2, 2, 'Sale Man Report', 'View', 'Y'),
(151, 2, 2, 'Sale Man Report', 'PDF', 'Y'),
(152, 2, 2, 'Tax Report', 'View', 'Y'),
(153, 2, 2, 'Tax Report', 'PDF', 'Y'),
(154, 2, 2, 'Sales Report', 'View', 'Y'),
(155, 2, 2, 'Sales Report', 'PDF', 'Y'),
(156, 2, 2, 'Voucher Report', 'View', 'Y'),
(157, 2, 2, 'Voucher Report', 'PDF', 'Y'),
(158, 2, 2, 'Cash Book', 'View', 'Y'),
(159, 2, 2, 'Cash Book', 'PDF', 'Y'),
(160, 2, 2, 'Day Book', 'View', 'Y'),
(161, 2, 2, 'Day Book', 'PDF', 'Y'),
(162, 2, 2, 'General Ledger', 'View', 'Y'),
(163, 2, 2, 'General Ledger', 'PDF', 'Y'),
(164, 2, 2, 'Trial Balance', 'View', 'Y'),
(165, 2, 2, 'Trial Balance', 'PDF', 'Y'),
(166, 2, 2, 'Trial with Activity', 'View', 'Y'),
(167, 2, 2, 'Trial with Activity', 'PDF', 'Y'),
(168, 2, 2, 'Yearly Summary', 'View', 'Y'),
(169, 2, 2, 'Yearly Summary', 'PDF', 'Y'),
(170, 2, 2, 'Profit & Loss', 'View', 'Y'),
(171, 2, 2, 'Profit & Loss', 'PDF', 'Y'),
(172, 2, 2, 'Balance Sheet', 'View', 'Y'),
(173, 2, 2, 'Balance Sheet', 'PDF', 'Y'),
(174, 2, 2, 'Invoice Summary', 'View', 'Y'),
(175, 2, 2, 'Invoice Summary', 'PDF', 'Y'),
(176, 2, 2, 'Party Wise Sale', 'View', 'Y'),
(177, 2, 2, 'Party Wise Sale', 'PDF', 'Y'),
(178, 2, 2, 'Branch', 'Create/List', 'Y'),
(179, 2, 2, 'Branch', 'Update', 'Y'),
(180, 2, 2, 'Branch', 'Delete', 'Y');
...
(1, 1, '2023-07-26', '2023-08-30', 'Ahsan Elahi', '9322880', 2, 1, 'Pakistani', '00923339322880', 'mr.elahi.ehsan@gmail.com', 'Address Line 1', '2023-07-26 06:18:23');
...
(1, 1, '2023-07-26', 'JV23070001', 510104, 1, NULL, 'Discount allowed', NULL, NULL, 25000.00, NULL),
(2, 1, '2023-07-26', 'JV23070001', 110400, 1, NULL, 'Discount allowed', NULL, NULL, NULL, 25000.00);
...
(1, 7, 1, 'JV23070001', '2023-07-26', 'Narration');
...
Create Or Replace VIEW `v_party`  AS SELECT `party`.`PartyID` AS `PartyID`, `party_category`.`PartyCategoryID` AS `PartyCategoryID`, `party_category`.`CategoryCode` AS `CategoryCode`, `party_category`.`CategoryName` AS `CategoryName`, `party`.`PartyName` AS `PartyName`, `party`.`Address` AS `Address`, `party`.`Phone` AS `Phone`, `party`.`Email` AS `Email`, `party`.`Active` AS `Active`, `party`.`InvoiceDueDays` AS `InvoiceDueDays`, `party`.`eDate` AS `eDate`, `user`.`FullName` AS `FullName`, `branch`.`BranchName` AS `BranchName`, `party`.`UserID` AS `UserID` FROM (((`party` join `party_category` on((`party`.`PartyCategoryID` = `party_category`.`PartyCategoryID`))) join `user` on((`party`.`UserID` = `user`.`UserID`))) join `branch` on((`user`.`BranchID` = `branch`.`BranchID`)))  ;
...
Create Or Replace VIEW `v_voucher`  AS SELECT `voucher_master`.`VoucherMstID` AS `VoucherMstID`, `voucher_type`.`VoucherCode` AS `VoucherCode`, `voucher_type`.`VoucherTypeName` AS `VoucherTypeName`, `voucher_master`.`Voucher` AS `Voucher`, `voucher_master`.`Date` AS `Date`, `voucher_master`.`Narration` AS `Narration`, `v_voucher_amount`.`Amount` AS `Amount`, `voucher_master`.`UserID` AS `UserID`, `user`.`FullName` AS `FullName`, `branch`.`BranchName` AS `BranchName` FROM ((((`voucher_master` join `voucher_type` on((`voucher_master`.`VoucherCodeID` = `voucher_type`.`VoucherTypeID`))) join `v_voucher_amount` on((`voucher_master`.`VoucherMstID` = `v_voucher_amount`.`VoucherMstID`))) join `user` on((`voucher_master`.`UserID` = `user`.`UserID`))) join `branch` on((`user`.`BranchID` = `branch`.`BranchID`)))  ;
...
--
ALTER TABLE `invoice_detail`
  MODIFY `InvoiceDetailID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `invoice_master`
--
ALTER TABLE `invoice_master`
  MODIFY `InvoiceMasterID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `journal`
  MODIFY `JournalID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `party`
  MODIFY `PartyID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `pettycash_detail`
  MODIFY `PettyDetID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `user_role`
  MODIFY `RoleId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=181;

--
-- AUTO_INCREMENT for table `visa`
--
ALTER TABLE `visa`
  MODIFY `VisaID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `voucher_detail`
--
ALTER TABLE `voucher_detail`
  MODIFY `VoucherDetID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `voucher_master`
--
ALTER TABLE `voucher_master`
  MODIFY `VoucherMstID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
